...
// apiNature: Pokemon Nature details as returned from the PokeAPI endpoint
...
// apiPokemon: Pokemon details as returned from the PokeAPI endpoint
...
// apiStat: Pokemon stat details as returned from the PokeAPI endpoint
type apiStat struct {
	ID             int    `json:"id"`
	Name           string `json:"name"`
	GameIndex      int    `json:"game_index"`
